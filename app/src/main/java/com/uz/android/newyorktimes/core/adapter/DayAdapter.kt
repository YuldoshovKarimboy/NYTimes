...
import com.uz.android.newyorktimes.databinding.ArticleDayBinding

class DayAdapter(var data: ArticlePage, var listener: OnArticleClickListener) :
    RecyclerView.Adapter<DayAdapter.Holder>() {

    inner class Holder(var bind: ArticleDayBinding) : RecyclerView.ViewHolder(bind.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder = Holder(
        DataBindingUtil.inflate(
            LayoutInflater.from(parent.context), R.layout.article_day, parent, false
        )
    )
